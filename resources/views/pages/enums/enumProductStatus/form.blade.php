@php use App\Models\Enums\EnumProductStatus; @endphp
@php
    /**
    * @var EnumProductStatus|null $model
    */
@endphp
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('enum-product-genre.filter') }}" class="text-muted text-hover-primary">
                            @lang('breadcrumb.Enum Product Genre')
                        </a>
                    </li>
                    <!--end::Item-->
                    ...
                    <li class="breadcrumb-item text-muted">
                        @if(!empty($model))
                            <strong class="text-primary">@lang('breadcrumb.Enum Product Genre Update')</strong>
                        @else
                            <strong class="text-primary">@lang('breadcrumb.Enum Product Genre Create')</strong>
                        @endif
                    </li>
                    <!--end::Item-->
                </ul>
            ...
            <div class="card" style="min-height: 700px!important;">
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <form id="kt_docs_repeater_form"
                          action="{{ !empty($model->getId()) ? route('enum-product-genre.edit', ['id' => $model->getId()]) : route('enum-product-status.store') }}"
                          method="post">
                        ...
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="required form-label" for="product_genre_name_uz">
                                @lang('model.name_uz')
                            </label>
                            <input
                                id="enum_product_genres_name_uz"
                                type="text"
                                name="name_uz"
                                class="form-control"
                        ...
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="required form-label" for="product_genres_name_oz">
                                @lang('model.name_oz')
                            </label>
                            <input
                                id="enum_product_genre_name_oz"
                                type="text"
                                name="name_oz"
                                class="form-control"
                                aria-label="Sizing example input"
                        ...
                        <!--end::Input group-->
                        <div class="mb-10">
                            <label for="enum_product_genre_enabled" class="required form-label">
                                @lang('model.enabled')
                            </label>
                            <select class="form-select" name="enabled" id="enum_product_genre_enabled"
