            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><strong
                            class="text-primary">@lang('breadcrumb.Company Partner')</strong></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('company-partner.filter') }}" method="get">
                                    @csrf
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('company-partner.filter') }}"
                            ...
                            <!--begin::Add user-->
                            <a
                                href="{{ route('company-partner.create') }}"
                                type="button"
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tr class="text-start text-muted fw-bold fs-6 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">@lang('model.website_link')</th>
                            <th class="min-w-125px">@lang('model.enabled')</th>
                            <th class="min-w-125px">@lang('model.logo')</th>
                        ...
                        @foreach($data as $item)
                            ...
                            <tr>
                                ...
                                <td class="align-items-center">
                                    <div
                                        class="symbol symbol-60 symbol-lg-100px symbol-fixed position-relative">
                                        <img src="{{$item->logo?->path . '/' . $item->logo?->file_name}}" alt="image"/>
                                        <div
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('company-partner.update', ['id' => $item->getId()]) }}"
                                        ...
                                        <div class="menu-item px-3">
                                            <a
                                                href="{{ route('company-partner.delete', ['id' => $item->getId()]) }}"
                                                class="menu-link px-3 company_partner_delete"
                                                data-action="{{ route('company-partner.delete', ['id' => $item->getId()]) }}">
                                                @lang('button.Delete')
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
