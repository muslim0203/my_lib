 ...
 */
class EnumProductTag extends Model
{
    use HasFactory;

    protected $table = 'enum_product_tags';
     ...
     * @param $count
     * @param $state
     * @return ProductTagFactory|Factory
     */
    public static function factory($count = null, $state = []): ProductTagFactory|Factory
    {
