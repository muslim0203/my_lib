            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><strong
                            class="text-primary">@lang('breadcrumb.Main Banner')</strong></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('banner.filter') }}" method="get">
                                    @csrf
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                            ...
                            <a
                                ...
                                <i class="ki-duotone ki-plus fs-2"></i>@lang('button.Add Banner')
                            </a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tr class="text-start text-muted fw-bold fs-6 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">@lang('model.banner_files')</th>
                            <th class="min-w-125px">@lang('model.enabled')</th>
                            <th class="text-end min-w-100px">@lang('button.Actions')</th>
                        </tr>
                        </thead>
                        <tbody class="text-gray-600 fw-semibold" id="banner_body">
                        @foreach($data as $item)
                            ...
                            <tr>
                                ...
                                <td class="align-items-center">
                                    <?php if(!empty($item->mainBannerFile)):?>
                                        <?php foreach($item->mainBannerFile as $fix):?>
                                        <div class="symbol symbol-90px symbol-lg-90px symbol-fixed position-relative">
                                            <img src="{{$fix->file?->path . '/' . $fix->file?->file_name}}" alt="image"/>
                                            <div class="position-absolute translate-middle border-body h-10px w-10px"></div>
                                        </div>
                                    <br>
                                    <br>
                                        <?php endforeach;?>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('banner.update', ['id' => $item->getId()]) }}"
                                               class="menu-link px-3 banner_edit"
                                            >
                                                @lang('button.Edit')
                                            </a>
                                        </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <a
                                                href="{{ route('banner.delete', ['id' => $item->getId()]) }}"
                                                class="menu-link px-3 banner_delete"
                                                data-action="{{ route('banner.delete', ['id' => $item->getId()]) }}">
                                                @lang('button.Delete')
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
