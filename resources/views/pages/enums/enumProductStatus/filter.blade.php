        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    @lang('client.Enum Product Status')
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><strong
                            class="text-primary">@lang('breadcrumb.Enum Product Status')</strong></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('enum-product-status.filter') }}" method="get">
                                    @csrf
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('enum-product-status.filter') }}"
                            ...
                            <!--begin::Add user-->
                            <a
                                href="{{ route('enum-product-status.create') }}"
                                type="button"
                                class="btn btn-primary">
                                <i class="ki-duotone ki-plus fs-2"></i>@lang('button.Add Enum Product Status')
                            </a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tbody class="text-gray-600 fw-semibold" id="enum_product_status_body">
                        @foreach($data as $item)
                            @php
                                /**
                                * @var \App\Models\Enums\EnumProductStatus $item
                                */
                            @endphp
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('enum-product-status.update', ['id' => $item->getId()]) }}"
                                               class="menu-link px-3 enum-product_status_edit"
                                            >
                                                @lang('button.Edit')
                                            </a>
                                        </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <a
                                                href="{{route('enum-product-status.delete', ['id' => $item->getId()]) }}"
                                                class="menu-link px-3 enum_product_status_delete"
                                                data-action="{{ route('enum-product-status.delete', ['id' => $item->getId()]) }}">
                                                @lang('button.Delete')
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
