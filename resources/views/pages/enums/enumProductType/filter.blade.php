            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><strong
                            class="text-primary">@lang('breadcrumb.Enum Product Type')</strong></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('enum-product-type.filter') }}" method="get">
                                    @csrf
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('enum-product-type.filter') }}"
                            ...
                            <!--begin::Add user-->
                            <a
                                href="{{ route('enum-product-type.create') }}"
                                type="button"
                                class="btn btn-primary">
                                <i class="ki-duotone ki-plus fs-2"></i>@lang('button.Add Enum Product Type')
                            </a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tbody class="text-gray-600 fw-semibold" id="enum_product_type_body">
                        @foreach($data as $item)
                            @php
                                /**
                                * @var \App\Models\Enums\EnumProductType $item
                                */
                            @endphp
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('enum-product-type.update', ['id' => $item->getId()]) }}"
                                               class="menu-link px-3 enum-product_type_edit"
                                            >
                                                @lang('button.Edit')
                                            </a>
                                        </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <a
                                                href="{{route('enum-product-type.delete', ['id' => $item->getId()]) }}"
                                                class="menu-link px-3 enum_product_type_delete"
                                                data-action="{{ route('enum-product-type.delete', ['id' => $item->getId()]) }}">
                                                @lang('button.Delete')
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
