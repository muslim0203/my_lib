            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><strong
                            class="text-primary">@lang('breadcrumb.Product')</strong></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <form action="{{ route('product.filter') }}" method="get">
                                    ...
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.title_uz')
                                                :</label>
                                            <input
                                                type="text"
                                                name="title_uz"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="@lang('model.title_uz')"
                                                value="{{ request('title_uz') }}"
                                            />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.title_oz')
                                                :</label>
                                            <input
                                                type="text"
                                                name="title_oz"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="@lang('model.title_oz')"
                                                value="{{ old('title_oz') }}"
                                            />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.title_ru')
                                                :</label>
                                            <input
                                                type="text"
                                                name="title_ru"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="@lang('model.title_ru')"
                                                value="{{ old('title_ru') }}"
                                            />
                                        </div>
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tr class="text-start text-muted fw-bold fs-6 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">@lang('model.wrapper_file_id')</th>
                            <th class="min-w-125px">@lang('model.title_oz')</th>
                            <th class="min-w-125px">@lang('model.title_uz')</th>
                            <th class="min-w-125px">@lang('model.title_ru')</th>
                            <th class="min-w-125px">@lang('model.created_at')</th>
                            <th class="min-w-125px">@lang('model.is_deleted')</th>
                        ...
                        @foreach($data as $key => $item)
                            ...
                            <tr>
                                ...
                                <td class="align-items-center">
                                    <a href="{{ route('product.view', ['id' => $item->getId()]) }}"
                                       class="menu-link px-3 product_edit"
                                    >
                                        <div
                                            class="symbol symbol-60px symbol-lg-100px symbol-fixed position-relative">
                                            <img
                                                src="{{$item->wrapperFile?->path . '/' . $item->wrapperFile?->file_name}}"
                                                alt="image"/>
                                            <div
                                                class="position-absolute translate-middle border-body h-20px w-20px"></div>
                                        </div>
                                    </a>
                                </td>
                                <td class="align-items-center">
