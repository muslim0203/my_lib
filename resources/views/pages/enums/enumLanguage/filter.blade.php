            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><strong
                            class="text-primary">@lang('breadcrumb.Enum Language')</strong></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="card">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('enum-language.filter') }}" method="get">
                                    @csrf
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('enum-language.filter') }}"
                            ...
                            <!--begin::Add user-->
                            <a
                                href="{{ route('enum-language.create') }}"
                                type="button"
                                class="btn btn-primary">
                                <i class="ki-duotone ki-plus fs-2"></i>@lang('button.Add Enum Language')
                            </a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tbody class="text-gray-600 fw-semibold" id="enum_languages_body">
                        @foreach($data as $item)
                            @php
                                /**
                                * @var \App\Models\Enums\EnumLanguage $item
                                */
                            @endphp
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('enum-language.update', ['id' => $item->getId()]) }}"
                                               class="menu-link px-3 enum-language_edit"
                                            >
                                                @lang('button.Edit')
                                            </a>
                                        </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <a
                                                href="{{route('enum-language.delete', ['id' => $item->getId()]) }}"
                                                class="menu-link px-3 enum_language_delete"
                                                data-action="{{ route('enum-language.delete', ['id' => $item->getId()]) }}">
                                                @lang('button.Delete')
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
