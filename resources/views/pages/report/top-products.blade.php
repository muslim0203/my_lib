    ...
    <div class="card m-10">
        ...
        <div class="card-header border-0 pt-6">
            <div class="row card-body">
                    ...
                    <div class="content">
                        <br>
                        <form action="{{ route('report.topProducts') }}" method="get">
                            <div class="row">
                                @csrf
                                <!--begin::Content-->
                                <!--begin::Input group-->
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <a href="{{ route('report.topProducts') }}"
        ...
        <div class="card-body py-4 table-responsive">
            ...
            <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                ...
                <tr class="text-start text-muted fw-bold fs-6 text-uppercase gs-0">
                    ...
                    <th class="text-center">@lang('model.Product Name')</th>
                    <th class="text-center">@lang('model.Customer Count')</th>
                    <th class="text-center">@lang('model.Sum Order Price')</th>
                    <th class="text-center">@lang('model.Sum Merchant Money Amount')</th>
                    <th class="text-center">@lang('model.Web Service Percentage')</th>
                    <th class="text-center">@lang('model.Web Service System Money Amount')</th>
                </tr>
                </thead>
                ...
                @foreach($data as $key => $item)
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="symbol symbol-70px symbol-lg-100px symbol-fixed">
                        ...
                        <td class="text-center">
                            {{$item->web_service_price_percentage . '%'}}
                        </td>
                        <td class="text-center">
                            {{$item->web_service_and_payment_system_money_amount}}
                        </td>
                    </tr>
                @endforeach
                </tbody>
