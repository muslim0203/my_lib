@php use App\Models\Enums\EnumProductGenre; @endphp
@php
    /**
    * @var EnumProductGenre|null $model
    */
@endphp
            ...
            <div class="card" style="min-height: 700px!important;">
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <form id="kt_docs_repeater_form"
                          action="{{ !empty($model->getId()) ? route('enum-product-genre.edit', ['id' => $model->getId()]) : route('enum-product-genre.store') }}"
                          method="post">
