...
use Database\Factories\EnumAcademicPositionFactory;
 ...
 */
class EnumAcademicPosition extends Model
{
    use HasFactory;
    ...
    /**
     * @return EnumAcademicPositionFactory|Factory
     */
    protected static function newFactory(): Factory|EnumAcademicPositionFactory
    {
        return EnumAcademicPositionFactory::new();
    }
