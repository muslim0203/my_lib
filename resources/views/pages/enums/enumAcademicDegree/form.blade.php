        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    @lang('client.Enum Academic Degree')
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('enum-academic-degree.filter') }}" class="text-muted text-hover-primary">
                            @lang('breadcrumb.Enum Academic Degree')
                        </a>
                    </li>
                    <!--end::Item-->
                    ...
                    <li class="breadcrumb-item text-muted">
                        @if(!empty($model))
                            <strong class="text-primary">@lang('breadcrumb.Enum Academic Degree Update')</strong>
                        @else
                            <strong class="text-primary">@lang('breadcrumb.Enum Academic Degree Create')</strong>
                        @endif
                    </li>
                    <!--end::Item-->
                </ul>
            ...
            <div class="card" style="min-height: 700px!important;">
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <form id="kt_docs_repeater_form"
                          action="{{ !empty($model->getId()) ? route('enum-academic-degree.edit', ['id' => $model->getId()]) : route('enum-academic-degree.store') }}"
                          method="post">
                        ...
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="required form-label" for="academic_degree_name_uz">
                                @lang('model.name_uz')
                            </label>
                            <input
                                id="enum_academic_degrees_name_uz"
                                type="text"
                                name="name_uz"
                                class="form-control"
                        ...
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="required form-label" for="academic_degree_name_oz">
                                @lang('model.name_oz')
                            </label>
                            <input
                                id="enum_academic_degrees_name_oz"
                                type="text"
                                name="name_oz"
                                class="form-control"
                                aria-label="Sizing example input"
                        ...
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="required form-label" for="academic_degree_name_ru">
                                @lang('model.name_ru')
                            </label>
                            <input
                                id="enum_academic_degrees_name_ru"
                                type="text"
                                name="name_ru"
                                class="form-control"
                                aria-label="Sizing example input"
                        ...
                        <!--end::Input group-->
                        <div class="mb-10">
                            <label for="enum_academic_degrees_enabled" class="required form-label">
                                @lang('model.enabled')
                            </label>
                            <select class="form-select" name="enabled" id="enum_academic_degree_enabled"
