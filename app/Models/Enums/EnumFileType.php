...
use Database\Factories\EnumFileTypeFactory;
 ...
 */
class EnumFileType extends Model
{
    use HasFactory;
    ...
    /**
     * @return EnumFileTypeFactory|Factory
     */
    protected static function newFactory(): EnumFileTypeFactory|Factory
    {
        return EnumFileTypeFactory::new();
    }
}
