            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><strong
                            class="text-primary">@lang('breadcrumb.Question Answer')</strong></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('question-answer.filter') }}" method="get">
                                    @csrf
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.content_uz')
                                                :</label>
                                            <input
                                                type="text"
                                                name="content_uz"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="@lang('model.content_uz')"
                                                value="{{ request('content_uz') }}"
                                            />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.content_oz')
                                                :</label>
                                            <input
                                                type="text"
                                                name="content_oz"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="@lang('model.content_oz')"
                                                value="{{ old('content_oz') }}"
                                            />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.content_ru')
                                                :</label>
                                            <input
                                                type="text"
                                                name="content_ru"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="@lang('model.content_ru')"
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('question-answer.filter') }}"
                            ...
                            <!--begin::Add user-->
                            <a
                                href="{{ route('question-answer.create') }}"
                                type="button"
                                class="btn btn-primary">
                                <i class="ki-duotone ki-plus fs-2"></i>@lang('button.Add Question Answer')
                            </a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tr class="text-start text-muted fw-bold fs-6 text-uppercase gs-0">
                            <th class="min-w-125px">@lang('model.content_oz')</th>
                            <th class="min-w-125px">@lang('model.content_uz')</th>
                            <th class="min-w-125px">@lang('model.content_ru')</th>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('question-answer.update', ['id' => $item->getId()]) }}"
                                               class="menu-link px-3 enum-categories_edit"
                                            >
                                                @lang('button.Edit')
                                            </a>
                                        </div>
                                        ...
                                        <div class="menu-item px-3">
                                            <a
                                                href="{{ route('question-answer.delete', ['id' => $item->getId()]) }}"
                                                class="menu-link px-3 question_answer_delete"
                                                data-action="{{ route('question-answer.delete', ['id' => $item->getId()]) }}">
                                                @lang('button.Delete')
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
