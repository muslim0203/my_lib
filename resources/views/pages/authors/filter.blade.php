@php use App\Core\Enums\Authors\AuthorStatusEnum;use App\Models\Authors\Author;use Illuminate\Support\Facades\Session; @endphp
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><strong
                                class="text-primary">@lang('breadcrumb.Author list')</strong></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('author.filter') }}" method="get">
                                    @csrf
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.passport')
                                                :</label>
                                            <input
                                                    type="text"
                                                    name="passport"
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.pin_fl')
                                                :</label>
                                            <input
                                                    type="text"
                                                    name="pin_fl"
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tr class="text-start text-muted fw-bold fs-6 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">@lang('model.passport')</th>
                            <th class="min-w-125px">@lang('model.pin_fl')</th>
                        ...
                        @foreach($data as $item)
                            ...
                            <tr>
                                ...
                                <td class="align-items-center">
                                    @if($item->getStatus() === AuthorStatusEnum::_ACTIVE->value)
                                        <div class="badge badge-light-success fw-bold">@lang('client.Active')</div>
                                    @elseif($item->getStatus() === AuthorStatusEnum::_UN_CONFIRMED->value)
                                        <div class="badge badge-light-warning fw-bold">@lang('client.UnConfirmed')</div>
                                    @elseif($item->getStatus() === AuthorStatusEnum::_DELETED->value)
                                        <div class="badge badge-light-danger fw-bold">@lang('client.Deleted')</div>
                                    @elseif($item->getStatus() === AuthorStatusEnum::_CANCELED->value)
                                        <div class="badge badge-light-danger fw-bold">@lang('client.Canceled')</div>
                                    @endif
                                </td>
                                <td class="text-end">
                                    <a href="#"
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('author.view', ['id' => $item->getId()]) }}"
