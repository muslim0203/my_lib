@php use App\Models\Enums\EnumEducationType; @endphp
@php
    /**
    * @var EnumEducationType|null $model
    */
@endphp
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                    @lang('client.Enum Education Types')
                </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('enum-education-type.filter') }}" class="text-muted text-hover-primary">
                            @lang('breadcrumb.Enum Education Type')
                        </a>
                    </li>
                    <!--end::Item-->
                    ...
                    <li class="breadcrumb-item text-muted">
                        @if(!empty($model))
                            <strong class="text-primary">@lang('breadcrumb.Enum Education Type Update')</strong>
                        @else
                            <strong class="text-primary">@lang('breadcrumb.Enum Education Type Create')</strong>
                        @endif
                    </li>
                    <!--end::Item-->
                </ul>
            ...
            <div class="card" style="min-height: 700px!important;">
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <form id="kt_docs_repeater_form"
                          action="{{ !empty($model->getId()) ? route('enum-education-type.edit', ['id' => $model->getId()]) : route('enum-education-type.store') }}"
                          method="post">
                        ...
                        <div class="mb-10">
                            ...
                            <input
                                id="enum_education_type_name_ru"
                                type="text"
                                name="name_ru"
                                class="form-control"
                                aria-label="Sizing example input"
                        ...
                        <div class="mb-10">
                            ...
                            <select class="form-select" name="enabled" id="enum_education_type_enabled"
