            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-muted"><strong
                            class="text-primary">@lang('breadcrumb.Enum Categories')</strong></li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('enum-categories.filter') }}" method="get">
                                    @csrf
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.icon')
                                                :</label>
                                            <input
                                                type="text"
                                                name="icon"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="@lang('model.icon')"
                                                value="{{ old('icon') }}"
                                            />
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="{{ route('enum-categories.filter') }}"
                            ...
                            <!--begin::Add user-->
                            <a
                                href="{{ route('enum-categories.create') }}"
                                type="button"
                                class="btn btn-primary">
                                <i class="ki-duotone ki-plus fs-2"></i>@lang('button.Add Enum Categories')
                            </a>
                            <!--end::Add user-->
                        </div>
                        <!--end::Toolbar-->
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tr class="text-start text-muted fw-bold fs-6 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">@lang('model.icon')</th>
                            <th class="min-w-125px">@lang('model.parent_id')</th>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('enum-categories.update', ['id' => $item->getId()]) }}"
                                        ...
                                        <div class="menu-item px-3">
                                            <a
                                                href="{{ route('enum-categories.delete', ['id' => $item->getId()]) }}"
                                                class="menu-link px-3 enum_categories_delete"
                                                data-action="{{ route('enum-categories.delete', ['id' => $item->getId()]) }}">
                                                @lang('button.Delete')
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
