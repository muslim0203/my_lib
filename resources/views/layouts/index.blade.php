...
<script type="module">
    ...
    ClassicEditor
        .create( document.querySelector( '#company_content_oz' ), {
    ...
    ClassicEditor
        .create( document.querySelector( '#company_content_uz' ), {
            plugins: [ Essentials, Paragraph, Bold, Italic, Font ],
            toolbar: [
                'undo', 'redo', '|', 'bold', 'italic', '|',
                'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor'
    ...
    ClassicEditor
        .create( document.querySelector( '#company_content_ru' ), {
            plugins: [ Essentials, Paragraph, Bold, Italic, Font ],
            toolbar: [
                'undo', 'redo', '|', 'bold', 'italic', '|',
                'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor'
    ...
    ClassicEditor
        .create( document.querySelector( '#question_answer_content_oz' ), {
            plugins: [ Essentials, Paragraph, Bold, Italic, Font ],
            toolbar: [
                'undo', 'redo', '|', 'bold', 'italic', '|',
                'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor'
    ...
    ClassicEditor
        .create( document.querySelector( '#question_answer_content_uz' ), {
            plugins: [ Essentials, Paragraph, Bold, Italic, Font ],
            toolbar: [
                'undo', 'redo', '|', 'bold', 'italic', '|',
                'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor'
    ...
    ClassicEditor
        .create( document.querySelector( '#question_answer_content_ru' ), {
            plugins: [ Essentials, Paragraph, Bold, Italic, Font ],
            toolbar: [
                'undo', 'redo', '|', 'bold', 'italic', '|',
                'fontSize', 'fontFamily', 'fontColor', 'fontBackgroundColor'
...
@endif
{{--Validation error toast end--}}

{{--Success message toast begin--}}
