                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                ...
                                <!--end::Separator-->
                                <form action="{{ route('authority.filter') }}" method="get">
                                    @csrf
                                    <!--begin::Content-->
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <input
                                                ...
                                                value="{{ request('name_ru') }}"
                                            />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('model.inn')
                                                :</label>
                                            <input
                                                type="text"
                                                name="inn"
                                                class="form-control form-control-solid mb-3 mb-lg-0"
                                                placeholder="@lang('model.inn')"
                                                value="{{ old('inn') }}"
                                            />
                                        </div>
                                        <!--end::Input group-->
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <table class="table table-striped table-row-bordered fs-6 gy-5" id="kt_datatable_horizontal_scroll">
                        ...
                        <tr class="text-start text-muted fw-bold fs-6 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">@lang('model.inn')</th>
                        ...
                        @foreach($data as $item)
                            @php
                                /**
                                * @var \App\Models\Authority\Authority $item
                                */
                            @endphp
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('authority.view', ['id' => $item->getId()]) }}"
