        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('company-partner.filter') }}" class="text-muted text-hover-primary">
                            @lang('breadcrumb.Company Partner')
                        </a>
                    </li>
                    <!--end::Item-->
                    ...
                    <li class="breadcrumb-item text-muted">
                        @if(!empty($model->getId()))
                            <strong class="text-primary">@lang('breadcrumb.Company Partner Update')</strong>
                        @else
                            <strong class="text-primary">@lang('breadcrumb.Company Partner Create')</strong>
                        @endif
                    </li>
                    <!--end::Item-->
                </ul>
            ...
            <div class="card" style="min-height: 700px!important;">
                ...
                <div class="card-body py-4 table-responsive">
                    ...
                    <form id="kt_docs_repeater_form"
                          action="{{ !empty($model->getId()) ? route('company-partner.edit', ['id' => $model->getId()]) : route('company-partner.store') }}"
                        ...
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="required form-label" for="company_partner_name_oz">
                                @lang('model.name_oz')
                            </label>
                            <input
                                id="company_partner_name_oz"
                                type="text"
                                name="name_oz"
                                class="form-control"
                        ...
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="required form-label" for="company_partner_name_uz">
                                @lang('model.name_uz')
                            </label>
                            <input
                                id="company_partner_name_oz"
                        ...
                        <!--begin::Input group-->
                        <div class="mb-10">
                            <label class="required form-label" for="company_partner_name_ru">
                                @lang('model.name_ru')
                            </label>
                            <input
                                id="company_partner_name_ru"
                                type="text"
                                name="name_ru"
                                class="form-control"
                                aria-label="Sizing example input"
                        ...
                        <div class="mb-10">
                            <label class="required form-label" for="company_partner_website_link">
                                @lang('model.website_link')
                            </label>
                            <input
                                id="company_partner_website_link"
                                type="text"
                                name="website_link"
                                class="form-control"
                                aria-label="Sizing example input"
                                aria-describedby="inputGroup-sizing-sm"
                                value="{{ !empty($model->getId()) ? $model->getWebsiteLink() : old('website_link') }}"
                                placeholder="@lang('model.Enter website_link')"
                            />
                            ...
                            <div class="mb-10">
                                <label class="required form-label" for="company_partner_file">
                                    @lang('model.file')
                                </label>
                                <input
                                    id="company_partner_file"
                                    type="file"
                                    name="file"
                                    class="form-control"
                                    aria-label="Sizing example input"
                        ...
                        <div class="mb-10">
                            <label for="company_partner_enabled" class="required form-label">
                                @lang('model.enabled')
                            </label>
                            <select class="form-select" name="enabled" id="company_partner_enabled"
